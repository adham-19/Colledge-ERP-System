...
const routes: Routes = [
  ...
  // Admin - نفس تقسيم الروابط الموجود في App.js الأصلي، كلها تحت AdminLayout (Header+Sidebar)
  {
    ...
    children: [
      ...
      { path: 'updatepassword', component: UpdatePasswordComponent, data: { firstTime: true } },
  ...
  // Faculty - نفس تقسيم الروابط الموجود في App.js الأصلي
  {
    ...
    children: [
      ...
      { path: 'password', component: FacultyUpdatePasswordComponent, data: { firstTime: true } },
  ...
  // Student - نفس تقسيم الروابط الموجود في App.js الأصلي
  {
    ...
    children: [
      ...
      { path: 'password', component: StudentUpdatePasswordComponent, data: { firstTime: true } },
