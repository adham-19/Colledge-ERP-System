...
export class UpdatePasswordComponent implements OnInit {
  ...
  update(): void {
    ...
    this.adminService
      .updatePassword({ newPassword: this.newPassword, confirmPassword: this.confirmPassword, email })
      .subscribe({
        next: () => {
          this.loading = false;
        ...
        error: (err) => {
          ...
          this.error = err.error?.mismatchError || err.error?.backendError || 'Something went wrong';
        },
      });
  }
}
