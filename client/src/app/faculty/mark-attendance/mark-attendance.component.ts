...
export class MarkAttendanceComponent implements OnInit {
  ...
  constructor(private adminService: AdminService, private facultyService: FacultyService) {}
  ...
  onSearch(): void {
    ...
    this.adminService.getSubject({ department: this.value.department, year: this.value.year }).subscribe({
